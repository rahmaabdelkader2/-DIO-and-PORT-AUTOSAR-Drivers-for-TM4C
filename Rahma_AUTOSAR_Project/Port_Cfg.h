...
/* Digital Input/output mode (GPIO) */
#define PORT_DIGITAL_IO                 (0U)

/* Analog mode */
#define PORT_ANALOG                     (12U)

/* Analog comparator mode */
#define PORT_ANALOG_COMPARATOR_MODE     (11U)
...
/* PA6 modes */
#define PORT_PA6_I2CISCL                (3U)
#define PORT_PA6_M1PWM2                 (5U)

/* PA7 modes */
#define PORT_PA7_I2CISDA                (3U)
#define PORT_PA7_MIPWM3                 (5U)
